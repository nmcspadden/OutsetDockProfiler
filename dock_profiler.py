...
p.add_argument("-s","--sign", help='sign package with valid identity')
...
print "outsetPath: %s" % outsetPath
print "WorkingPath: %s" % workingPath
print "Combo: %s" % os.path.join(workingPath, outsetPath)
# Place the script into the outset folder in the temporary path
os.makedirs(os.path.join(workingPath, outsetPath))
print "Temp path: %s" % os.path.join(workingPath, outsetPath)
